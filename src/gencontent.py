...
def generate_page(content_path: pathlib.Path, template_path: pathlib.Path, public_path: pathlib.Path, basepath) -> None:
...
def generate_pages_recursive(dir_path_content: pathlib.Path, template_path: pathlib.Path, dest_dir_path: pathlib.Path, basepath) -> None:
