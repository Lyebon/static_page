...
class TestTextNode(unittest.TestCase):
    ...
    def test_split_images(self):
        node = TextNode(
            "This is text with an [go to boot dev link](https://www.boot.dev) and another [second link to go](https://www.boot.dev)",
            TextType.TEXT,
        )
        ...
        self.assertListEqual(
            [
                TextNode("This is text with an ", TextType.TEXT),
                TextNode("go to boot dev link", TextType.LINK, "https://www.boot.dev"),
                TextNode(" and another ", TextType.TEXT),
                TextNode("second link to go", TextType.LINK, "https://www.boot.dev"),
            ],
            new_nodes,
        )
